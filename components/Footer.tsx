    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="container-max section-padding">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold text-accent-orange mb-4">Quick Links</h3>
            <ul className="space-y-2">
              {footer.links.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-gray-400 hover:text-light-yellow transition-colors"
                  >
                    {link.text}
                  </a>
                </li>
          ...
          {/* Social Links */}
          <div>
            <h3 className="text-lg font-bold text-accent-orange mb-4">Connect With Us</h3>
            <div className="flex space-x-4">
              {footer.socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-accent-orange transition-colors group"
